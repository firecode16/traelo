...
const technologyCategories = [
  ...
  { label: '🖥️ Monitores', value: 'monitors' },
  { label: '⌨️ Periféricos', value: 'peripherals' },
  { label: '🔌 Cables/Adaptadores', value: 'cables' },
  { label: '📷 Cámaras', value: 'cameras' },
  { label: '🖨️ Impresoras', value: 'printers' },
  { label: '🎮 Gaming', value: 'gaming' },
  { label: '🔋 Baterías', value: 'batteries' },
];

// Especificaciones predefinidas comunes
const commonSpecs = [
  'RAM',
  'Almacenamiento',
  'Pantalla',
...
const predefinedColors = [
  ...
  { name: 'Gris Espacial', value: '#717378' },
...
// Configuraciones de variantes comunes
const commonVariants = {
  smartphones: ['8GB+128GB', '8GB+256GB', '12GB+256GB', '12GB+512GB'],
  laptops: ['8GB+256GB', '16GB+512GB', '32GB+1TB'],
  accessories: ['Estándar', 'Pro', 'Max'],
};
    ...
    <TouchableOpacity style={styles.productCard} onPress={() => onView(item)}>
      ...
      <View style={styles.productInfo}>
        ...
        <Text style={styles.productCategory}>
          {technologyCategories.find((cat) => cat.value === item.category)
            ?.label || item.category}
        </Text>
        <Text style={styles.productPrice}>${item.price.toFixed(2)}</Text>
        <Text style={styles.productBrand}>{item.brand}</Text>
        <Text style={styles.productVariants}>
          {item.variants?.length || 0} variantes disponibles
        </Text>
      </View>
...
const TechnologyCatalog = ({ navigation, route }) => {
  ...
  const addVariant = () => {
    setForm({
      ...
      variants: [
        ...
        {
          color: '#000000',
          configuration: commonVariants[form.category]?.[0] || 'Estándar',
          stock: '0',
        },
      ],
    });
  ...
  const getAvailableConfigurations = () => {
    return commonVariants[form.category] || ['Estándar', 'Pro', 'Max'];
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const newProduct = {
        ...
        warranty: form.warranty.duration ? form.warranty : null,
      };
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.formSection}>
                ...
                <TextInput
                  ...
                  style={[
                    styles.input, invalidFields.name && styles.invalidInput,
                  ]}
                />
                ...
                <View style={styles.row}>
                  <View style={[styles.inputGroup, styles.flex1]}>
                    <TextInput
                      ...
                      style={[
                        styles.input, invalidFields.price && styles.invalidInput,
                      ]}
                    />
                  </View>
                ...
                <TextInput
                  placeholder="Modelo (ej: iPhone 15 Pro, Galaxy S24)"
                  placeholderTextColor={COLORS.placeholder}
                  value={form.model}
                ...
                <View
                  style={[
                    styles.pickerContainer, invalidFields.category && styles.invalidInput,
                  ]}
                >
                  <Picker
              ...
              <View style={styles.formSection}>
                ...
                {form.specifications.map((spec, index) => (
                  <View key={index} style={styles.specCard}>
                    ...
                    <View style={styles.specFieldsVertical}>
                      <View style={styles.inputGroup}>
                        <TextInput
                          placeholder="Característica (ej: RAM, Pantalla)"
                          placeholderTextColor={COLORS.placeholder}
                          value={spec.key}
                          onChangeText={(text) =>
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.warrantyFields}>
                  <View style={styles.inputGroup}>
                    <TextInput
                      ...
                      onChangeText={(text) =>
                        setForm({
                          ...form,
                          warranty: { ...form.warranty, duration: text },
                        })
                      }
                      style={styles.input}
                    />
                  ...
                  <View style={styles.inputGroup}>
                    <View style={styles.pickerContainer}>
                      <Picker
                        selectedValue={form.warranty.type}
                        onValueChange={(value) =>
                          setForm({
                            ...form,
                            warranty: { ...form.warranty, type: value },
                          })
                        }
                        style={styles.picker}
                      >
                        <Picker.Item label="Tipo de garantía" value="" />
                        <Picker.Item label="Fabricante" value="manufacturer" />
                        <Picker.Item label="Tienda" value="store" />
                        <Picker.Item label="Extendida" value="extended" />
                      </Picker>
                    </View>
                  </View>
                </View>
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.imageGrid}>
                  ...
                  <TouchableOpacity
                    onPress={pickImages}
                    style={[
                      styles.imagePicker, invalidFields.images && styles.invalidInput,
                    ]}
                  >
                ...
                {form.variants.map((variant, index) => (
                  <View key={index} style={styles.variantCard}>
                    ...
                    <View style={styles.variantFields}>
                        ...
                        <View style={styles.colorGrid}>
                          {predefinedColors.map((color, colorIndex) => (
                            <TouchableOpacity
                              key={colorIndex}
                              style={[
                                styles.colorOption, { backgroundColor: color.value }, variant.color === color.value && styles.colorSelected,
                              ]}
                              onPress={() =>
                                updateVariant(index, 'color', color.value)
                              }
                            />
                          ))}
                        </View>
                      ...
                      <View style={styles.variantInputGroup}>
                        <Text style={styles.variantLabel}>Especificación</Text>
                        <View style={styles.pickerContainer}>
                          <Picker
                            selectedValue={variant.configuration}
                            onValueChange={(value) =>
                              updateVariant(index, 'configuration', value)
                            }
                            style={styles.picker}
                          >
                      ...
                      <View style={styles.carouselIndicators}>
                        {selectedProduct.images.map((_, index) => (
                          <View
                            key={index}
                            style={[
                              styles.carouselIndicator, index === currentImageIndex && styles.carouselIndicatorActive,
                            ]}
                          />
                        ))}
                      </View>
                  ...
                  <View style={styles.productDetails}>
                    ...
                    {selectedProduct.warranty && (
                      <View style={styles.detailSection}>
                        ...
                        <Text style={styles.detailText}>
                          {selectedProduct.warranty.duration} meses -{' '}
                          {selectedProduct.warranty.type}
                        </Text>
                      </View>
                    )}
